...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False, local_rank=-1, world_size=1):
    ...
    nw = min([os.cpu_count() // world_size, batch_size if batch_size > 1 else 0, 32])  # number of workers
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        # Check cache
        cache_path = str(Path(self.label_files[0]).parent) + '_train.cache'  # cached labels
        ...
        # print('self.label_files ', self.label_files[0])
        # print('cache ', cache_path)
        # for id, x in enumerate(self.img_files):
        #     print(id, ' ', x)
        #     print('\t', cache[x])
        # print("iteration %d times, finish" % (len(self.img_files)))

        # imgpathtmp = '/home/wangxiaoyun/yolov5-2.0/data/quexianVoc/JPEGImages/20190810_1002.jpg'
        # # imgpathtmp = '/home/wangxiaoyun/yolov5-2.0/data/quexianVoc/JPEGImages/20200110_760.jpg'
        # # imgpath = '/home/wangxiaoyun/yolov5-2.0/data/quexianVoc/JPEGImages/20190810_1003.jpg'
        # labeltmp = '/home/wangxiaoyun/yolov5-2.0/data/quexianVoc/JPEGImages/20190810_1002.txt'
        # image0 = cv2.imread(imgpath)
        # if image0 is None:
        #     print('cv2 None-----------')
        # else:
        #     print('cv2 ', image0.shape)

        # image = Image.open(imgpath)
        # if image1 is None:
        #     print('Image None-----------')
        # else:
        #     print('Image ', exif_size(image1))

        # xtmp = {}
        # try:
        #     l = []
        #     image = Image.open(imgpathtmp)
        #     image.verify()  # PIL verify
        #     # _ = io.imread(img)  # skimage verify (from skimage import io)
        #     shape = exif_size(image)  # image size
        #     assert (shape[0] > 9) & (shape[1] > 9), 'image size <10 pixels'
        #     print('11111111')
        #     if os.path.isfile(labeltmp):
        #         print('222222222')
        #         with open(labeltmp, 'r') as f:
        #             print('222222222')
        ...
        #         print('33333333')
        #     xtmp[imgpathtmp] = [l, shape]
        #     print('33333333')
        # except Exception as e:
        #     print('4444444444444')
        #     xtmp[imgpathtmp] = None
        #     print('4444444444444')
        #     print('WARNING: %s: %s' % (imgpathtmp, e))
        #####################
        ...
        # print('label file  ', self.label_files)
